...
from env import TensorNetworkEnv
from env import NodesSycamoreN53M12, get_nodes_list_of_tensor_train
from opt import ObjectiveTask, OptimizerTask, OptimizerOpti
from opt import opt_train, opt_eval

TEN = th.Tensor

# NodesList, BanEdges = NodesSycamoreN53M12, 0
NodesList, BanEdges = get_nodes_list_of_tensor_train(len_list=200), 200
